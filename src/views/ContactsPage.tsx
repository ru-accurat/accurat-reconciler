    ...
    <div className="flex h-full">
      ...
      <div className="w-80 flex-shrink-0 border-r border-gray-200 flex flex-col">
        ...
        <div className="px-4 py-2 flex items-center gap-2 text-xs text-gray-500 border-b border-gray-100">
          ...
          <button onClick={() => handleSort('type')} className="flex items-center gap-1 hover:text-gray-300">
            Type <ArrowUpDown size={10} />
          </button>
          <span className="text-gray-300">|</span>
          <button onClick={() => handleSort('transactions')} className="flex items-center gap-1 hover:text-gray-300">
              ...
              <div
                ...
                className={`px-4 py-3 border-b border-gray-100 cursor-pointer transition-colors ${
                  selectedId === contact.id
                    ? 'bg-[var(--c-gray-50)] border-l-2 border-l-[var(--c-gray-900)]'
                    : 'hover:bg-[var(--c-gray-100)]'
                }`}
              >
        ...
        {isEditing ? (
                ...
                <div className="space-y-1 mb-2">
                  {editForm.transactionPatterns.map((pattern, index) => (
                    <div key={index} className="flex items-center gap-2 bg-gray-50 rounded-lg px-3 py-1.5">
                      <span className="text-sm font-mono text-gray-700 flex-1 truncate">{pattern}</span>
                      <button
                        onClick={() => removePattern(index)}
                        className="p-0.5 hover:bg-red-900/30 rounded text-gray-400 hover"
                      >
                        <X size={12} />
                      </button>
                    </div>
          ...
          <div className="p-6">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="btn-sm flex items-center gap-1 text-red-600 hover:bg-red-900/20 border border-red-200 rounded-lg px-3 py-1.5"
                >
                  <Trash2 size={14} />
                  Delete
                </button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              <div className="card p-4">
                <div className="flex items-center gap-2 mb-3">
                  <Building2 size={16} className="text-[var(--c-gray-900)]" />
                  <h4 className="font-medium text-sm text-gray-900">Details</h4>
                </div>
                <div className="space-y-2 text-sm">
                  ...
                  {selectedContact.vatTaxId && (
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-gray-900 font-mono">{selectedContact.vatTaxId}</span>
                    </div>
                  )}
                  <div className="flex items-center justify-between">
                    <span className="text-gray-500">Source</span>
                    <span className="text-gray-900 capitalize">{selectedContact.source}</span>
                  </div>
                  <div className="flex items-center justify-between">
              ...
              <div className="card p-4">
                <div className="flex items-center gap-2 mb-3">
                  <FileText size={16} className="text-[var(--c-gray-900)]" />
                  <h4 className="font-medium text-sm text-gray-900">Contact Info</h4>
                </div>
                <div className="space-y-2 text-sm">
            ...
            <div className="card p-4 mb-6">
              <h4 className="font-medium text-sm text-gray-900 mb-3">Financial Summary</h4>
            ...
            {selectedContact.transactionPatterns.length > 0 && (
              <div className="card p-4 mb-6">
                <div className="flex items-center gap-2 mb-3">
                  <Tag size={16} className="text-[var(--c-gray-900)]" />
                  <h4 className="font-medium text-sm text-gray-900">Transaction Patterns</h4>
                </div>
              ...
              <div className="card p-4">
                ...
                <div className="space-y-1">
                  {contactTransactions.map((t) => (
                    <div key={t.id} className="flex items-center justify-between py-2 px-3 rounded-lg hover:bg-[var(--c-gray-100)]">
                      <div className="flex-1 min-w-0">
                        <p className="text-sm text-gray-900 truncate">{t.rawDescription}</p>
